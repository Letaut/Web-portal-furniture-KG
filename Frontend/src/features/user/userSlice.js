    ...
    builder
      ...
      .addCase(loginUser.fulfilled, (state, action) => {
        ...
        if (state.isSuccess === true) {
          ...
          toast.info("Пользователь успешно вошел в систему");
        }
      })
      ...
      .addCase(forgotPasswordToken.fulfilled, (state, action) => {
        ...
        if (state.isSuccess) {
          toast.success("Письмо с забытым паролем успешно отправлено!");
        }
      })
      ...
      .addCase(resetPassword.fulfilled, (state, action) => {
        ...
        if (state.isSuccess) {
          toast.success("Смена пароля прошла успешно!");
        }
      })
