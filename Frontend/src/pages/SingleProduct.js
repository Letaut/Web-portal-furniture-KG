          ...
          <div className="col-6">
            <div className="main-product-details">
              ...
              <div className="border-bottom py-3">
                <p className="price"> Сом. {productState?.price}/-</p>
              ...
              <div className=" py-3">
                ...
                <div className="d-flex gap-10 flex-column  my-3">
                  ...
                  Бесплатная доставка и возврат доступны для всех заказов! <br /> Мы отправляем все заказы внутри Кыргызстана в течение 
                    <b> 2-3 рабочих дней</b>
                  </p>
                </div>
